...
session_start();
 include '../konek.php'; // untuk mengambil koneksi ke db
		...
		$queri = mysqli_query($koneksi,"INSERT INTO barang_masuk VALUES ('','".$_POST['kd_barang']."','".$_POST['jumlah_masuk']."','".$_POST['tanggal_masuk']."','".$_SESSION['id']."')"); // query menambahkan data ke tabel 
		if ($queri) {
