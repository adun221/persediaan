...
session_start();
 include '../konek.php'; // untuk mengambil koneksi ke db
		...
		$queri = mysqli_query($koneksi,"UPDATE barang_masuk set nama_barang='".$_POST['nama_barang']."' , jumlah_masuk='".$_POST['jumlah_masuk']."', tanggal_masuk='".$_POST['tanggal_masuk']."' where id_masuk='".$_POST['id_masuk']."' "); // query edit data ke tabel 
